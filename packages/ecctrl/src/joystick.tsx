...
import { useJoystickControls } from './stores';
...
const JoystickComponents = (props: EcctrlJoystickProps) => {
  ...
  const onTouchMove = useCallback(
    (e: TouchEvent) => {
      ...
      const runState =
        joystickDis > joystickMaxDis * (props.joystickRunSensitivity ?? 0.9);
...
export const EcctrlJoystick = forwardRef<HTMLDivElement, EcctrlJoystickProps>(
  (props, ref) => {
    ...
    return (
      <div ref={ref}>
        {/* biome-ignore lint/nursery/noStaticElementInteractions: safe */}
        <div
          id='ecctrl-joystick'
